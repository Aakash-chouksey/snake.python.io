...
class Snake:
    ...
    def draw(self):
        self.parent_screen.fill((24, 12, 245))
...
class Game:
    def __init__(self) :
        pygame.init()
        pygame.display.set_caption("sanke and apple")
    ...
    def show_game_over(self):
        ...
        line2 = font.render("play game again, press enter", True, (255,255,255))
